  ...
  "lessons": [
    {
      ...
      "penjelasan": "Lanjutan dari modul HTML Dasar: box-1 dan box-2 sekarang baru berupa <div> polos, belum terlihat seperti kotak. Setiap elemen HTML sebenarnya adalah kotak yang terdiri dari <code>content</code> (isi), <code>padding</code> (jarak dalam ke isi), <code>border</code> (garis tepi), dan <code>margin</code> (jarak luar ke elemen lain) — gabungan ketiganya disebut <strong>Box Model</strong>. Beri properti ini pada class <code>.box</code> supaya box-1 dan box-2 sekaligus jadi kotak yang rapi.",
      ...
      "tantangan": "Di CSS Website Pertamamu, buat aturan .box { } yang menarget box-1 DAN box-2 sekaligus (keduanya sama-sama punya class \"box\"). Isi dengan border, border-radius, padding, margin, dan background-color supaya \"TEKS BOX 1\" dan \"TEKS BOX 2\" akhirnya terlihat seperti kotak sungguhan."
    },
    {
      "id": "css-dasar-2",
    ...
    },
    {
      ...
      "penjelasan": "Selamat! Kalau kamu mengikuti semua lesson dari HTML Dasar sampai di sini, halamanmu sekarang seharusnya sudah persis seperti rencana Website Pertama: judul dengan font unik, dua kotak (list & gambar dengan teks di atasnya), paragraf, tombol Google, teks berjalan, dan tabel nilai. Bandingkan kodemu dengan contoh lengkap di bawah ini, perbaiki kalau ada bagian yang beda, lalu klik tombol \"Simpan sebagai File\" di playground untuk mengunduh hasil akhirnya.",
